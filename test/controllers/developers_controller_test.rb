...
class DevelopersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create developer" do
    assert_difference('Developer.count') do
      post developers_url, params: { developer: { score: @developer.score, skill: @developer.skill, username: @developer.username } }
    end
  ...
  test "should update developer" do
    patch developer_url(@developer), params: { developer: { score: @developer.score, skill: @developer.skill, username: @developer.username } }
